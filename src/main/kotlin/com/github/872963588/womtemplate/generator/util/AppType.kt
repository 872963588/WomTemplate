package com.github.872963588.womtemplate.generator.util
...
enum class AppType(val key: String) {
    ...
    fun fullBaseActivity(): String {
        return when (this) {
        List -> "com.webuy.common.base.CBaseActivity"
        Activity -> "cn.com.haoyiku.base.HYKBaseActivity"
        Fragment -> "com.income.common.base.CBaseActivity"
        }
    }
